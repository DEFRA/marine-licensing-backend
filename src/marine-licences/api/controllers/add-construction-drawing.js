...
import { addConstructionDrawingSchema } from '../../models/site-details/construction-drawing.js'
import { StatusCodes } from 'http-status-codes'
import { ObjectId } from 'mongodb'
import { collectionMarineLicences } from '../../../shared/common/constants/db-collections.js'
import { authorizeOwnership } from '../../../shared/helpers/authorize-ownership.js'

export const addConstructionDrawingController = {
  options: {
    payload: {
      parse: true,
      output: 'data'
    ...
    validate: {
      query: false,
      payload: addConstructionDrawingSchema
    }
  },
  handler: async (request, h) => {
    try {
      ...
      const result = await db.collection(collectionMarineLicences).updateOne(
        ...
        {
          $push: { [`${sitePath}.constructionDrawings`]: {} },
      ...
      throw Boom.internal(`Error adding construction drawing: ${error.message}`)
    }
  }
}
