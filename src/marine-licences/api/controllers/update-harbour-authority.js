...
import { harbourAuthoritySchema } from '../../models/harbour-authority.js'

export const updateHarbourAuthorityController = {
  options: {
    payload: {
      parse: true,
      output: 'data'
  ...
  handler: async (request, h) => {
    try {
      ...
      throw Boom.internal(`Error updating harbour authority: ${error.message}`)
    }
  }
}
