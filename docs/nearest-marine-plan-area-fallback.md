...
| -------------------------------------- | --------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------ |
| `mp-policies:nearest-area-fallback`    | `success`       | The fallback ran and assigned policies. This is the provenance record, and a data-quality signal about plan boundary accuracy near those sites.                              | licence id, site coverage, and per-site `regionref@distance` |
